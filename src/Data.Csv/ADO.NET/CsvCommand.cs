...
public class CsvCommand : FileCommand
{
    ...
    public CsvCommand(string cmdText, CsvConnection connection, CsvTransaction transaction) : base(cmdText, connection, transaction)
    {
    }
    ...
    {
        return new CsvDataReader(queryParser, ((CsvConnection)Connection!).FileReader);
    }

    public override IDbDataParameter CreateParameter()
    {
        return new CsvParameter();
    }
}