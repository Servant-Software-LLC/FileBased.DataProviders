...
internal class JsonModificationCommandBatchFactory : IModificationCommandBatchFactory
{
    public JsonModificationCommandBatchFactory(ModificationCommandBatchFactoryDependencies dependencies)
    {
