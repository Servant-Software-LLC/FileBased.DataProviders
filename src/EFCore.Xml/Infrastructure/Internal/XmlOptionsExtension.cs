...
public class XmlOptionsExtension : RelationalOptionsExtension
{
    ...
    public XmlOptionsExtension(XmlOptionsExtension copyFrom) : base(copyFrom)
    {
    ...
    private sealed class ExtensionInfo : RelationalExtensionInfo
    {
        ...
        public override void PopulateDebugInfo(IDictionary<string, string> debugInfo)
        {
            ...
            //  debugInfo["ServantSoftware.EntityFrameworkCore.Xml:" + nameof(NpgsqlDbContextOptionsBuilder.SetPostgresVersion)]
