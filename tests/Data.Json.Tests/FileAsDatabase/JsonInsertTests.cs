...
public class JsonInsertTests
{
    ...
    {
        var sandboxId = $"{GetType().FullName}.{MethodBase.GetCurrentMethod()!.Name}";
        InsertTests.Insert_ShouldInsertNullData(() => new JsonConnection(ConnectionStrings.Instance.FileAsDB.Sandbox("Sandbox", sandboxId)));
    }
    ...
    public void Insert_ShouldBeFormatted()
    {
        ...
        InsertTests.Insert_ShouldBeFormattedForFile(() => new JsonConnection(sandboxConnectionString));
    }
