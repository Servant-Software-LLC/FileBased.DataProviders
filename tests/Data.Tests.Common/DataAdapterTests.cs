...
namespace Data.Json.Tests.FileAsDatabase
{
    public static class DataAdapterTests
    {
        ...
        public static void DataAdapter_ShouldFillTheDataSet(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var connection = createFileConnection();
        ...
        public static void Adapter_ShouldReturnData(Func<FileConnection> createFileConnection, bool dataTypesAreAlwaysString = false)
        {
            // Arrange
            var connection = createFileConnection();
        ...
        public static void DataAdapter_ShouldFillTheDataSet_WithFilter(Func<FileConnection> createFileConnection, bool dataTypesAreAlwaysString = false)
        {
            // Arrange
            var connection = createFileConnection();
        ...
        public static void Adapter_ShouldReadDataWithSelectedColumns(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var connection = createFileConnection();
            var dataSet = new DataSet();
        ...
        public static void FillSchema_ShouldReturnDataTableWithAllColumns(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var dataSet = new DataSet();
            var connection = createFileConnection();
        ...
        public static void FillSchema_ShouldThrowInvalidOperationException_WhenSelectCommandIsNull(Func<FileDataAdapter> createFileDataAdapter)
        {
            // Arrange
            var dataSet = new DataSet();
        ...
        public static void FillSchema_ShouldThrowInvalidOperationException_WhenSelectCommandConnectionIsNull(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var dataSet = new DataSet();
            var connection = createFileConnection();
        ...
        public static void CreateAdapter_ShouldThrowArgumentException_WhenSelectCommandTextIsNullOrEmpty(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var dataSet = new DataSet();
            var connection = createFileConnection();
        ...
        public static void GetFillParameters_ShouldReturnCorrectParametersForQueryWithoutParameters(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var connection = createFileConnection();
        ...
        public static void GetFillParameters_ShouldReturnCorrectParametersForQueryWithParameters(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var connection = createFileConnection();
        ...
        public static void GetFillParameters_ShouldReturnEmptyParametersForNonSelectQuery(Func<FileConnection> createFileConnection)
        {
            // Arrange
            var connection = createFileConnection();
