...
/// <summary>
/// A stream that produces XLS data on demand from TRecord instances.
...
/// </summary>
internal class UnendingXlsStream<TRecord> : UnendingStream, IDisposable
{
    ...
    public UnendingXlsStream(Func<TRecord> createObject)
    {
