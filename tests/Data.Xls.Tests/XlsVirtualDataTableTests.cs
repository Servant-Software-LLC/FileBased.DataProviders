...
public class XlsVirtualDataTableTests
{
    private readonly ITestOutputHelper logger;

    public XlsVirtualDataTableTests(ITestOutputHelper logger)
    {
        this.logger = logger;
    }
...
[
  ...
  },
  {
    ...
    ""IsHappy"": 0
        ...
        XlsVirtualDataTable table = new(stream, "MyTable", 10, null, 4096);
...
[
  ...
  },
  {
    ...
    ""Company"": ""Bobson""
        ...
        //Act:  Columns are determined in the ctor.
        XlsVirtualDataTable table = new(stream, "MyTable", 1, null, 4096);
