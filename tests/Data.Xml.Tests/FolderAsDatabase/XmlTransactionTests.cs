...
public partial class XmlTransactionTests
{
    ...
    public void Transaction_ShouldInsertDataIntoDatabase()
    {
        ...
        var command = new XmlCommand("INSERT INTO locations (id,city, state,zip) VALUES (@Id,@City, @State,@Zip)", connection, transaction);

        command.Parameters.Add(new XmlParameter("Id", "5601"));
        command.Parameters.Add(new XmlParameter("City", "MiranShah"));
        command.Parameters.Add(new XmlParameter("State", "MA"));
        command.Parameters.Add(new XmlParameter("Zip", "102"));
    ...
    public void Transaction_ShouldUpdateDataInDatabase()
    {
        ...
        command.Parameters.Add(new XmlParameter("Salary", 10));
        ...
        command.Parameters.Add(new XmlParameter("Name", "Shahid Khan"));
        command.Parameters.Add(new XmlParameter("Salary", 20));
        ...
        Assert.Equal(1, dataSet.Tables[0].Rows.Count);
        Assert.Equal(20M, dataSet.Tables[0].Rows[0]["salary"]);
